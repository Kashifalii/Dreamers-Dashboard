            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="max-h-96 overflow-y-auto">
                <DropdownMenuItem className="p-4 flex flex-col items-start gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">$15,000 from Tech Solutions Inc</p>
                  <p className="text-xs text-muted-foreground">2 hours ago</p>
                </DropdownMenuItem>
                <DropdownMenuItem className="p-4 flex flex-col items-start gap-1">
                  <p className="text-sm">Student enrolled in course</p>
                  <p className="text-xs text-muted-foreground">Sarah Johnson enrolled in React Development</p>
                  <p className="text-xs text-muted-foreground">5 hours ago</p>
                </DropdownMenuItem>
                <DropdownMenuItem className="p-4 flex flex-col items-start gap-1">
                  <p className="text-sm">Assignment submitted</p>
                  <p className="text-xs text-muted-foreground">Michael Chen submitted State Management Project</p>
